...
if __name__ == '__main__': 
    ...
    if filtered_df is None:
        ...
        with tab2:
                ...
                m_c.st.caption("This model __assumes a linear relationship between your completed activities and the future.__ If you changed your training volume __suddenly__, this model will lose accuracy. Adjust the configuration of the model to use activity data beginning from when you changed your training volume. Similarly, __you want to have a significant number of activities such that predicitions have a reliable basis__ to be found upon. Insufficient data can lead to unreliable and potentially misleading predictions.")                                 
                m_c.st.write("---")
